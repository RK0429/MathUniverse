...
| `type`         | The specific kind of content. Values can include `axiom`, `theorem`, `lemma`, `definition`, `example` (based on `lean_stmt_export` kinds, see `design/lean-parser.md`). | `theorem`                              |
